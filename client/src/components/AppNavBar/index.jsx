...
export default function Index(props) {
  ...
  return (
    <div className="container">
      <nav className="navbar navbar-light navbar-expand-md bg-dark justify-content-center  bg-dark text-white my-2">
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form onSubmit={onSubmit} encType='application/x-www-form-urlencoded | multipart/form-data | text/plain'>
